...
ActiveRecord::Schema.define(:version => 20130217173516) do
  ...
  add_index "clients", ["remote_id"], :name => "index_clients_on_remote_id"
  ...
  add_index "clients_groups", ["client_id", "group_id"], :name => "index_clients_groups_on_client_id_and_group_id", :unique => true
